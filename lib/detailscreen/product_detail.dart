...
import '../firebase/firebasecart.dart';
                          ...
                          return Container(
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                ...
                                image: NetworkImage(
                                  widget.productdetails[0]['images'][index]
                                      .toString(),
                                ),
                                fit: BoxFit.cover,
                              ),
                          ...
                          [
                            {
                              ...
                              "discountPercentage": widget
                                  .productdetails[0]["discountPercentage"],
                              "price": widget.productdetails[0]["price"],
                              "stock": widget.productdetails[0]["stock"],
                              "rating": widget.productdetails[0]["rating"],
                              "category": widget.productdetails[0]["category"],
